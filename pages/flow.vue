    ...
    <div class="body_wrap">
      <div class="section --1">
        ...
        <div class="section_content --3">
          ...
          <div class="section_body">
            <div class="body_img">
              <img class="img" src="~/assets/images/marriage-gate.webp" alt="ステップ3">
            </div>
            <div class="body_block">
              <div class="text">
      ...
      <div class="section --1" id="href_4">
        ...
        <div class="section_content --4">
          ...
          <div class="section_body">
            <div class="body_img">
              <img class="img" src="~/assets/images/marriage-gate.webp" alt="ステップ4">
            </div>
            <div class="body_block">
              <div class="text">
        ...
        <div class="section_content --5">
          ...
          <div class="section_body">
            <div class="body_img">
              <img class="img" src="~/assets/images/marriage-gate.webp" alt="ステップ5">
            </div>
            <div class="body_block">
              <div class="text">
        ...
        <div class="section_content --6">
          ...
          <div class="section_body">
            <div class="body_img">
              <img class="img" src="~/assets/images/marriage-gate.webp" alt="ステップ6">
            </div>
            <div class="body_block">
              <div class="text">
        ...
        <div class="section_content --7">
          ...
          <div class="section_body">
            <div class="body_img">
              <img class="img" src="~/assets/images/marriage-gate.webp" alt="ステップ7">
            </div>
            <div class="body_block">
              <div class="text">
