      ...
      <div class="body_wrap">
        <div class="section --1">
          ...
          <div class="section_content --2">
            ...
            <div class="section_body">
              <div class="body_img">
                <img
                  class="img"
                  src="~/assets/images/flow_consulting.webp"
                  alt="ステップ2"
                />
              </div>
              <div class="body_block">
          ...
          <div class="section_content --3">
            <h2 class="section_title" data-number="03">
              <span class="inline-block">プロフィール作成、</span
              ><span class="inline-block">写真撮影</span>
            </h2>
            <div class="section_body">
              <div class="body_img">
                <img
                  class="img"
                  src="~/assets/images/flow_photo_studio.webp"
                  alt="ステップ3"
                />
              </div>
              <div class="body_block">
        ...
        <div class="section --1" id="href_4">
          <h1 class="title">
            <span class="inline-block">お相手探しから</span
            ><span class="inline-block">成婚まで</span>
          </h1>
          <div class="section_content --4">
            ...
            <div class="section_body">
              <div class="body_img">
                <img
                  class="img"
                  src="~/assets/images/flow_matching.webp"
                  alt="ステップ4"
                />
              </div>
              <div class="body_block">
                <div class="text">
                  IBJに在籍している106958名（2026年1月現在）の会員様の中から、プロフィールやお見合い写真などで気になる相手を探し、お見合い申込をしましょう。<br />
          ...
          <div class="section_content --5">
            ...
            <div class="section_body">
              <div class="body_img">
                <img
                  class="img"
                  src="~/assets/images/flow_first_contact.webp"
                  alt="ステップ5"
                />
              </div>
              <div class="body_block">
          ...
          <div class="section_content --6">
            <h2 class="section_title" data-number="03">
              <span class="inline-block">プレ交際</span
              ><span class="inline-block">（～交際2か月頃まで）</span>
            </h2>
            <div class="section_body">
              <div class="body_img">
                <img
                  class="img"
                  src="~/assets/images/flow_pre_dating.webp"
                  alt="ステップ6"
                />
              </div>
              <div class="body_block">
          ...
          <div class="section_content --7">
            <h2 class="section_title" data-number="04">
              <span class="inline-block">真剣交際</span
              ><span class="inline-block">（交際２カ月頃～）</span>
            </h2>
            <div class="section_body">
              <div class="body_img">
                <img
                  class="img"
                  src="~/assets/images/flow_pre.webp"
                  alt="ステップ7"
                />
              </div>
              <div class="body_block">
          ...
          <div class="section_content --8">
            ...
            <div class="section_body">
              <div class="body_img">
                <img
                  class="img"
                  src="~/assets/images/flow_propose.webp"
                  alt="ステップ8"
                />
              </div>
              <div class="body_block">
          ...
          <div class="section_content --9">
            ...
            <div class="section_body">
              <div class="body_img">
                <img
                  class="img"
                  src="~/assets/images/happy_wedding.webp"
                  alt="ステップ9"
                />
              </div>
              <div class="body_block">
...
onMounted(() => {
  ...
  trigger.forEach((value) => {
    let array: gsap.core.Tween = gsap.to(value.action, {
      ...
      transform: 'scale(1.1)',
      'background-image':
        'linear-gradient(135deg, #000875 0%, #176dee 50%,  #17aaee 100%)',
      color: '#eff4f4',
    })
